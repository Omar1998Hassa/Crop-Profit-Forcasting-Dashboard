...
walmart = pd.read_csv(r"C:\Users\Omar\Downloads\VisualData2project\scale-ai-templates-master\scale-ai-templates-master\apps\time-series-forecasting\data.csv")
